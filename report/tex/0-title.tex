...
of the \textit{Na\"ive Bayes Classifier} --- a fast and simple classifier that uses Bayes' theorem 
...
Python \& C++ codes for the above classifier are provided at \Hyperlink{https://github.com/s-rohit/naive-bayes}{Github}.
\par\medskip
